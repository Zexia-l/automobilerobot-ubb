...
bool astra_camera_msgs__msg__device_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("astra_camera_msgs.msg._device_info.DeviceInfo", full_classname_dest, 45) == 0);
  }
  astra_camera_msgs__msg__DeviceInfo * ros_message = _ros_message;
  {  // header
  ...
  {  // vid
    ...
    ros_message->vid = (int32_t)PyLong_AsLong(field);
    Py_DECREF(field);
  }
  {  // pid
  ...
  {  // supported_min_sdk_version
    PyObject * field = PyObject_GetAttrString(_pymsg, "supported_min_sdk_version");
    if (!field) {
      return false;
    }
    assert(PyUnicode_Check(field));
    ...
    rosidl_runtime_c__String__assign(&ros_message->supported_min_sdk_version, PyBytes_AS_STRING(encoded_field));
    Py_DECREF(encoded_field);
    Py_DECREF(field);
  }
  {  // hardware_version
...
PyObject * astra_camera_msgs__msg__device_info__convert_to_py(void * raw_ros_message)
{
  ...
  {
    PyObject * pymessage_module = PyImport_ImportModule("astra_camera_msgs.msg._device_info");
  ...
  {  // vid
    PyObject * field = NULL;
    field = PyLong_FromLong(ros_message->vid);
    {
  ...
  {  // supported_min_sdk_version
    PyObject * field = NULL;
    field = PyUnicode_DecodeUTF8(
      ros_message->supported_min_sdk_version.data,
      strlen(ros_message->supported_min_sdk_version.data),
      "replace");
    if (!field) {
      return NULL;
    }
