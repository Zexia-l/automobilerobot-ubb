...
#include "astra_camera_msgs/srv/detail/get_device_info__rosidl_typesupport_microxrcedds_c.h"
...
typedef astra_camera_msgs__srv__GetDeviceInfo_Request _GetDeviceInfo_Request__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _GetDeviceInfo_Request__ros_msg_type * ros_message = (_GetDeviceInfo_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _GetDeviceInfo_Request__ros_msg_type * ros_message = (const _GetDeviceInfo_Request__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
...
{
  bool full_bounded;
  return max_serialized_size_astra_camera_msgs__srv__GetDeviceInfo_Request(&full_bounded, 0);
}
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, astra_camera_msgs, srv, GetDeviceInfo_Request)() {
...
typedef astra_camera_msgs__srv__GetDeviceInfo_Response _GetDeviceInfo_Response__ros_msg_type;
  ...
  ucdrBuffer * cdr)
{
  ...
  _GetDeviceInfo_Response__ros_msg_type * ros_message = (_GetDeviceInfo_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  size_t current_alignment)
{
  ...
  const _GetDeviceInfo_Response__ros_msg_type * ros_message = (const _GetDeviceInfo_Response__ros_msg_type *)(untyped_ros_message);
  (void)ros_message;
  ...
  // Member: info
  current_alignment +=
    get_serialized_size_astra_camera_msgs__msg__DeviceInfo(&ros_message->info, current_alignment);
  // Member: success
  {
  ...
  size_t current_alignment)
{
  ...
  *full_bounded = true;
  ...
  // Member: info
  current_alignment +=
    max_serialized_size_astra_camera_msgs__msg__DeviceInfo(full_bounded, current_alignment);
  // Member: success
...
{
  bool full_bounded;
  return max_serialized_size_astra_camera_msgs__srv__GetDeviceInfo_Response(&full_bounded, 0);
}
...
const rosidl_message_type_support_t *
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, astra_camera_msgs, srv, GetDeviceInfo_Response)() {
...
ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_c, astra_camera_msgs, srv, GetDeviceInfo)() {
