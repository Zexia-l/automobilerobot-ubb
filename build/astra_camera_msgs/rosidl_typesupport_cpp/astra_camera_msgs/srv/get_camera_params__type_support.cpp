...
static const _GetCameraParams_Request_type_support_symbol_names_t _GetCameraParams_Request_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, astra_camera_msgs, srv, GetCameraParams_Request)),
  }
};
...
static const _GetCameraParams_Response_type_support_symbol_names_t _GetCameraParams_Response_message_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, astra_camera_msgs, srv, GetCameraParams_Response)),
  }
};
...
static const _GetCameraParams_type_support_symbol_names_t _GetCameraParams_service_typesupport_symbol_names = {
  {
    ...
    STRINGIFY(ROSIDL_TYPESUPPORT_INTERFACE__SERVICE_SYMBOL_NAME(rosidl_typesupport_microxrcedds_cpp, astra_camera_msgs, srv, GetCameraParams)),
  }
};
