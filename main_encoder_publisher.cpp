...
const float wheel_radius = 0; // radius roda dalam meter
const float wheel_base_x = 0;  // jarak antara roda depan-belakang (m)
const float wheel_base_y = 0;  // jarak antara roda kiri-kanan (m)
