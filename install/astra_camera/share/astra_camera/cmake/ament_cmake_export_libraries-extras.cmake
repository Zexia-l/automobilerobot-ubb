...
set(_exported_libraries "astra_camera")
  ...
  while(_i LESS _length)
    ...
    if(NOT _library_dirs)
      ...
      if(NOT _lib)
        # warn about not existing library and later ignore it
        message(WARNING
          "Package 'astra_camera' exports library '${_library_name}' with LIBRARY_DIRS '${_library_dirs}' which couldn't be found")
      endif()
    endif()
    if(_lib)
      list(APPEND astra_camera_LIBRARIES ${_cfg} "${_lib}")
...
# TODO(dirk-thomas) deduplicate astra_camera_LIBRARIES
